...
const projects = [
    {
        ...
        link: "https://globaldreamconect.netlify.app"
    },
    {
        id: 2,
        ...
        link: "https://cmritcsds4.netlify.app"
    },
    {
        id: 3,
...
export default function Projects() {
    return (
        <section id="work" className="relative min-h-screen bg-[#121212] py-24 px-4 md:px-12 z-20">
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                className={`relative p-8 rounded-2xl border border-white/10 backdrop-blur-md bg-gradient-to-br ${project.color} hover:border-white/30 transition-all duration-300 group cursor-pointer overflow-hidden h-full`}
                            >
